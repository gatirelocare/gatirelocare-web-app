    ...
    <footer className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-blue-100">
              Premium relocation services with expert handling and
              uncompromising care for your belongings.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-blue-700 pt-8 text-center text-blue-200">
          <p>&copy; 2025 GatiRelocare Packers Movers. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
